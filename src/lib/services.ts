...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    metaDescription: "Custom pergola installation in the Bay Area. Shade structures, outdoor rooms, composite decking coordination & 3D design. Free consultation. (510) 755-5616.",
    heroText: "Create shade, structure, and a true outdoor room with a custom pergola designed around how your family uses the backyard.",
    content: [
    ...
    benefits: [
      ...
      "Designed with pavers, turf, lighting, and drainage as one system",
      "Options for aluminum, wood-look, louvered, attached, or freestanding structures",
      "Improves comfort during hot Bay Area afternoons",
      "3D renderings show scale and placement before build",
      "Can be paired with composite decking, privacy screens, and outdoor lighting",
    ],
    faqs: [
      { q: "Do pergolas need permits in the Bay Area?", a: "Some pergolas and shade structures require permits depending on size, height, attachment to the house, electrical work, and city rules. We review this during consultation and help coordinate the permit path when required." },
      { q: "Can you add a pergola to an existing patio?", a: "Yes. We can evaluate your existing patio or deck and design a pergola that fits the structure, drainage, and traffic flow. If the base needs upgrades, we will explain that before quoting." },
      { q: "What can be included with a pergola project?", a: "Common add-ons include paver patios, composite decking, lighting, privacy screens, outdoor kitchens, turf, seat walls, planting beds, and drainage improvements." },
    ],
  },
  {
    slug: "fence-and-gate",
    ...
    metaDescription: "Fence and gate installation in the Bay Area. Privacy fencing, side gates, repairs, custom outdoor entries & landscape integration. Free consultation. (510) 755-5616.",
    heroText: "Add privacy, security, and a clean finished edge to your yard with fences and gates built to match the rest of the landscape.",
    content: [
    ...
    benefits: [
      ...
      "Useful for side-yard access, pet areas, and backyard separation",
      "Integrated with pavers, lighting, turf, and planting design",
      "Repair and replacement options for smaller projects",
      "Practical site review before quoting",
      "Built by a licensed and insured landscape contractor",
    ],
    faqs: [
      { q: "Do you handle small fence or gate repairs?", a: "Yes. We can handle smaller fence and gate repairs when they fit our schedule or when they are part of a broader landscape project." },
      { q: "Can a new gate match my existing fence?", a: "Usually. We review the existing material, height, posts, hardware, and finish during the site visit and recommend the cleanest match or upgrade." },
      { q: "Do fence projects need neighbor approval?", a: "Shared fence lines often require neighbor coordination, and some HOAs have material or height rules. We flag those items before work begins so there are no surprises." },
    ],
  },
  {
    ...
    metaDescription: "Irrigation and drainage services in the Bay Area. Drip irrigation, yard drainage, grading, French drains, and water-smart landscape upgrades. (510) 755-5616.",
    ...
    benefits: [
      ...
      "Can include drip irrigation, smart controllers, grading, French drains, and catch basins",
      "Reduces muddy areas, standing water, erosion, and plant stress",
      "Designed around real site conditions instead of generic layouts",
    ],
    faqs: [
      { q: "How do I know if my yard has a drainage problem?", a: "Common signs include standing water, muddy areas, sinking pavers, water near the foundation, erosion, dying plants in low spots, and runoff from downspouts that has nowhere to go." },
      { q: "Can drainage be fixed during a paver or turf project?", a: "Yes, and that is usually the best time. We can correct grading, add drains, and route water properly before the final pavers or turf are installed." },
      { q: "Do you install water-saving irrigation?", a: "Yes. We commonly use drip irrigation, zone planning, and controller coordination to keep planting beds healthy while reducing water waste." },
    ],
  },
  {
