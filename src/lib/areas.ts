...
export const areas: CityData[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Visionable Landscaping brings Fremont-based local knowledge and Bay Area-wide experience to every Dublin project. Our transparent process includes a free on-site consultation, detailed 3D renderings, locked-in pricing, and daily progress updates. See our 160+ project photos on Yelp and discover why Dublin families trust us with their outdoor spaces.",
    ],
