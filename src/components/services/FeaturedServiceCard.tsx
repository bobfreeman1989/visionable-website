...
export function FeaturedServiceCard({ service }: FeaturedServiceCardProps) {
  const content = (
    <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:-translate-y-1 hover:shadow-lg hover:border-primary/30 transition-all duration-300 h-full relative overflow-hidden group">
